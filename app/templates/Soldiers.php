...
<div>
	<?php
		if (empty($soldiers)){
			echo 'No Schema Soldiers are currently defined for this schema. Please, help this project <a href="https://github.com/StateMapper/StateMapper/blob/master/documentation/guides/SOLDIERS.md#top" target="_blank">enrolling as a Soldier now</a>!';
